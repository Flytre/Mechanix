...
public class EnergyMeterWidget extends TexturedButtonWidget {
    ...
    public void renderToolTip(MatrixStack matrices, int mouseX, int mouseY) {
        ...
        MutableText line = new TranslatableText("gui.mechanix.energy").append(new LiteralText(Formatter.formatNumber(handler.getEnergy(), "J")));
        MutableText line2 = new TranslatableText("gui.mechanix.max").append(new LiteralText(Formatter.formatNumber(handler.getMaxEnergy(), "J")));
