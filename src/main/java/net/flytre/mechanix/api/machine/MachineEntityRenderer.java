...
public class MachineEntityRenderer<T extends BlockEntity> extends BlockEntityRenderer<T> {
    ...
    public void render(T entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        for (Direction direction : Direction.values()) {
            ...
            } else if (entity instanceof FluidInventory) {
                RenderUtils.renderSide(getTexture(((FluidInventory) entity).getFluidIO().get(direction)), matrices, vertexConsumers, light, overlay, direction);
            }
        }
