 ...
 * If your machine contains FLUIDS, use the PanelledFluidHandledScreenWithEnergy class
 *
...
public abstract class EnergyScreen<T extends StandardEnergyScreenHandler<?>> extends HandledScreen<T> implements CoordinateProvider {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        for (AbstractButtonWidget button : buttons)
            if (button.isHovered() && (button instanceof MultistateButton || button instanceof EnergyMeterWidget))
