package net.flytre.mechanix.client;
...
import net.flytre.mechanix.api.fluid.screen.FluidPacketsClient;
import net.flytre.mechanix.api.machine.MachineEntityRenderer;
import net.flytre.mechanix.api.upgrade.UpgradePacketsClient;
...
import net.flytre.mechanix.block.quarry.QuarryRenderer;
...
import net.flytre.mechanix.block.transmuter.TransmuterScreen;
import net.flytre.mechanix.block.xp_bank.BankScreen;
...
import net.flytre.mechanix.client.model.*;
...
public class MechanixClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        BlockEntityRendererRegistry.INSTANCE.register(MachineRegistry.HYDRATOR.getEntityType(), MachineEntityRenderer::new);
        BlockEntityRendererRegistry.INSTANCE.register(MachineRegistry.POWERED_FURNACE.getEntityType(), MachineEntityRenderer::new);
        BlockEntityRendererRegistry.INSTANCE.register(MachineRegistry.GENERATOR.getEntityType(), MachineEntityRenderer::new);
        BlockEntityRendererRegistry.INSTANCE.register(MachineRegistry.SAWMILL.getEntityType(), MachineEntityRenderer::new);
        BlockEntityRendererRegistry.INSTANCE.register(MachineRegistry.LIQUIFIER.getEntityType(), MachineEntityRenderer::new);
        BlockEntityRendererRegistry.INSTANCE.register(MachineRegistry.FOUNDRY.getEntityType(), MachineEntityRenderer::new);
        BlockEntityRendererRegistry.INSTANCE.register(MachineRegistry.DISTILLER.getEntityType(), MachineEntityRenderer::new);
        BlockEntityRendererRegistry.INSTANCE.register(MachineRegistry.ENCHANTER.getEntityType(), MachineEntityRenderer::new);
        BlockEntityRendererRegistry.INSTANCE.register(MachineRegistry.DISENCHANTER.getEntityType(), MachineEntityRenderer::new);
        BlockEntityRendererRegistry.INSTANCE.register(MachineRegistry.PRESSURIZER.getEntityType(), MachineEntityRenderer::new);
        BlockEntityRendererRegistry.INSTANCE.register(MachineRegistry.CENTRIFUGE.getEntityType(), MachineEntityRenderer::new);
        BlockEntityRendererRegistry.INSTANCE.register(MachineRegistry.HYDROPONATOR.getEntityType(), MachineEntityRenderer::new);
        BlockEntityRendererRegistry.INSTANCE.register(MachineRegistry.CRAFTER.getEntityType(), MachineEntityRenderer::new);
        BlockEntityRendererRegistry.INSTANCE.register(MachineRegistry.ITEM_COLLECTOR.getEntityType(), MachineEntityRenderer::new);
        BlockEntityRendererRegistry.INSTANCE.register(MachineRegistry.QUARRY.getEntityType(), QuarryRenderer::new);
        BlockEntityRendererRegistry.INSTANCE.register(MachineRegistry.XP_BANK.getEntityType(), MachineEntityRenderer::new);
        BlockEntityRendererRegistry.INSTANCE.register(MachineRegistry.TRANSMUTER.getEntityType(), MachineEntityRenderer::new);
        ...
        ScreenRegistry.register(MachineRegistry.XP_BANK.getHandlerType(), BankScreen::new);
        ScreenRegistry.register(MachineRegistry.TRANSMUTER.getHandlerType(), TransmuterScreen::new);
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(MachineRegistry.ITEM_COLLECTOR.getBlock(), RenderLayer.getCutout());

        //TODO: REMOVE?
        BlockRenderLayerMap.INSTANCE.putBlock(MachineRegistry.QUARRY.getBlock(), RenderLayer.getCutout());


        ModelLoadingRegistry.INSTANCE.registerModelProvider(new MechanixModelManager());
        ModelLoadingRegistry.INSTANCE.registerVariantProvider((i) -> new MechanixModelManager());
