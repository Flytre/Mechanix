...
public class LiquifierScreen extends PanelledFluidHandledScreenWithEnergy<LiquifierHandler> {


    private final Identifier background = new Identifier("mechanix:textures/gui/container/liquifier.png");

    public LiquifierScreen(LiquifierHandler handler, PlayerInventory inventory, Text title) {
