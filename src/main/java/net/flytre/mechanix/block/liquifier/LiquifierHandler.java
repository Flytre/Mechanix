...
public class LiquifierHandler extends ItemEnergyScreenHandler<LiquifierEntity> {

    public LiquifierHandler(int syncId, PlayerInventory playerInventory, PacketByteBuf buf) {
        super(MachineRegistry.LIQUIFIER.getHandlerType(), syncId, playerInventory, LiquifierEntity::new, buf);
    }

    public LiquifierHandler(int syncId, PlayerInventory playerInventory, LiquifierEntity entity, PropertyDelegate propertyDelegate) {
        super(MachineRegistry.LIQUIFIER.getHandlerType(), syncId, playerInventory, entity, propertyDelegate);
    }

    @Override
    protected void constCommon(PlayerInventory playerInventory, LiquifierEntity entity) {
        this.addSlot(new Slot(entity, 0, 69, 35));
        this.addSlot(new FluidSlot(entity, 0, 128, 13, false));
