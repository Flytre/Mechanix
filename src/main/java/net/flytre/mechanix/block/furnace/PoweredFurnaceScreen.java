...
public class PoweredFurnaceScreen extends EnergyScreen<PoweredFurnaceHandler> {

    private final Identifier background = new Identifier("mechanix:textures/gui/container/powered_furnace.png");

    public PoweredFurnaceScreen(PoweredFurnaceHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawBackground(MatrixStack matrices, float delta, int mouseX, int mouseY) {
        ...
        this.drawTexture(matrices, x + 89, y + 37, 176, 0, (int) (23 * handler.operationProgress()), 16);
