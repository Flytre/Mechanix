...
public class PressurizerScreen extends EnergyScreen<PressurizerHandler> {

    private final Identifier background = new Identifier("mechanix:textures/gui/container/processing.png");


    public PressurizerScreen(PressurizerHandler handler, PlayerInventory inventory, Text title) {
