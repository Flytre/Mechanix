...
public class FluidTank extends BlockWithEntity {
    ...
    public FluidTank(Settings settings, long capacity) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (world.isClient)
            ...
            if (fluidTank instanceof FluidTankEntity) {
                if (stack.getItem() == Items.BUCKET) {
                    return ((FluidTankEntity) fluidTank).tryRemoveFluid(player, hand, stack) ? ActionResult.SUCCESS : ActionResult.FAIL;
                } else if (stack.getItem() instanceof BucketItem) {
                    return ((FluidTankEntity) fluidTank).tryAddFluid(player, hand, stack) ? ActionResult.SUCCESS : ActionResult.FAIL;
                }
            }
    ...
    public int getComparatorOutput(BlockState state, World world, BlockPos pos) {
        return FluidInventory.calculateComparatorOutput((FluidInventory) world.getBlockEntity(pos));
    }
}
