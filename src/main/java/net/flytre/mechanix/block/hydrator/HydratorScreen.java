...
public class HydratorScreen extends PanelledFluidHandledScreen<HydratorHandler> {

    private final Identifier background;


    public HydratorScreen(HydratorHandler handler, PlayerInventory inventory, Text title) {
