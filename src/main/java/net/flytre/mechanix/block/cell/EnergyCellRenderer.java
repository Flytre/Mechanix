...
public class EnergyCellRenderer extends BlockEntityRenderer<EnergyCellEntity> {
    ...
    @Override
    public void render(EnergyCellEntity cell, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        double percent = cell.getEnergy() / cell.getMaxEnergy();
