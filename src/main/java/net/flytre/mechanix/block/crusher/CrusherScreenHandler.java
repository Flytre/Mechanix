...
public class CrusherScreenHandler extends EnergyScreenHandler {
    private final Inventory inventory;
    private final World world;

    public CrusherScreenHandler(int syncId, PlayerInventory playerInventory, PacketByteBuf buf) {
        this(syncId, playerInventory, new CrusherBlockEntity(), new ArrayPropertyDelegate(24));
        this.pos = buf.readBlockPos();
    }

    public CrusherScreenHandler(int syncId, PlayerInventory playerInventory, CrusherBlockEntity entity, PropertyDelegate propertyDelegate) {
