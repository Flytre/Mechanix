...
public class SolarPanelScreenHandler extends EnergyScreenHandler {
    ...
    public SolarPanelScreenHandler(int syncId, PlayerInventory playerInventory, SolarPanelEntity entity, PropertyDelegate propertyDelegate) {
