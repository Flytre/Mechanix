...
public class DisenchanterScreenHandler extends EnergyScreenHandler {
    private final Inventory inventory;

    public DisenchanterScreenHandler(int syncId, PlayerInventory playerInventory, PacketByteBuf buf) {
        this(syncId, playerInventory, new DisenchanterEntity(), new ArrayPropertyDelegate(24));
        this.pos = buf.readBlockPos();
    }

    public DisenchanterScreenHandler(int syncId, PlayerInventory playerInventory, DisenchanterEntity entity, PropertyDelegate propertyDelegate) {
