...
public class DistillerScreen extends PanelledFluidHandledScreenWithEnergy<DistillerHandler> {


    private final Identifier background = new Identifier("mechanix:textures/gui/container/distiller.png");

    public DistillerScreen(DistillerHandler handler, PlayerInventory inventory, Text title) {
