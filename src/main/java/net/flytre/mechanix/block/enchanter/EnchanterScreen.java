...
public class EnchanterScreen extends PanelledFluidHandledScreenWithEnergy<EnchanterHandler> {


    private final Identifier background = new Identifier("mechanix:textures/gui/container/enchanter.png");

    public EnchanterScreen(EnchanterHandler handler, PlayerInventory inventory, Text title) {
