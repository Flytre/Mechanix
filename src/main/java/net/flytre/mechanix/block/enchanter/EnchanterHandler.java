...
import net.flytre.mechanix.api.upgrade.UpgradeSlot;
...
public class EnchanterHandler extends ItemEnergyScreenHandler<EnchanterEntity> {

    public EnchanterHandler(int syncId, PlayerInventory playerInventory, PacketByteBuf buf) {
        super(MachineRegistry.ENCHANTER.getHandlerType(), syncId, playerInventory, EnchanterEntity::new, buf);
    }

    public EnchanterHandler(int syncId, PlayerInventory playerInventory, EnchanterEntity entity, PropertyDelegate propertyDelegate) {
        super(MachineRegistry.ENCHANTER.getHandlerType(), syncId, playerInventory, entity, propertyDelegate);
    }

    @Override
    protected void constCommon(PlayerInventory playerInventory, EnchanterEntity entity) {
        this.addSlot(new Slot(entity, 0, 79, 35));
