...
public class HydroponatorRecipeCategory extends AbstractCustomCategory<HydroponatorRecipe> {
    ...
    @Override
    public @NotNull List<Widget> setupDisplay(AbstractRecipeDisplay<HydroponatorRecipe> recipeDisplay, Rectangle bounds) {
