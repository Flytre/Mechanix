...
public abstract class MoltenPerlium extends AbstractMetallicFluid {
    ...
    {
        return FluidRegistry.STILL_PERLIUM;
    }

    @Override
    public Fluid getFlowing()
    {
        return FluidRegistry.FLOWING_PERLIUM;
    }

    @Override
    public Item getBucketItem()
    {
        return FluidRegistry.PERLIUM_BUCKET;
    }

    @Override
    protected BlockState toBlockState(FluidState fluidState)
    {
        return FluidRegistry.PERLIUM_BLOCK.getDefaultState().with(Properties.LEVEL_15, method_15741(fluidState));
    }
