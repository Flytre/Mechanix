...
public class BlockRegistry {
    ...
    public static Block VYSTERIUM_BLOCK = new Block(FabricBlockSettings.of(Material.METAL).requiresTool().strength(6.0F, 6.0F));
    public static Block NEPTUNIUM_BLOCK = new Block(FabricBlockSettings.of(Material.METAL).requiresTool().strength(6.0F, 6.0F));
