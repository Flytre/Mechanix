...
public class BlockRegistry {
    ...
    public static Block HARDENED_GLASS = new GlassBlock(FabricBlockSettings.of(Material.GLASS).strength(4.0f,10.0f).sounds(BlockSoundGroup.GLASS).nonOpaque().allowsSpawning(BlockRegistry::never).solidBlock(BlockRegistry::never).suffocates(BlockRegistry::never).blockVision(BlockRegistry::never));
