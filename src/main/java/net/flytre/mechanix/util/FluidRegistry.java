...
import net.flytre.mechanix.fluid.ExperienceFluid;
import net.flytre.mechanix.fluid.FluidType;
...
public class FluidRegistry {
    ...
    public static void init() {
        ...
        RAW_TIN.setBlock();
        LIQUID_XP = new FluidType("liquid_xp", () -> (new ExperienceFluid(() -> LIQUID_XP)), () -> (new MetallicFluid.Flowing(() -> LIQUID_XP)));
        LIQUID_XP.setBlock();
    }
}
